...
/* package NetMod-0.1.0.0 */
#ifndef VERSION_NetMod
#define VERSION_NetMod "0.1.0.0"
#endif /* VERSION_NetMod */
#ifndef MIN_VERSION_NetMod
#define MIN_VERSION_NetMod(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_NetMod */
...
#define CURRENT_COMPONENT_ID "NetMod-0.1.0.0-inplace-NetMod"
